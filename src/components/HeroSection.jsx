    ...
    <>
      <section className={`min-h-screen pt-4`}>
        ...
        <div className="relative ">
          ...
          <div className="p-4 md:p-8 border-t-4 bg-white border-t-[#a6a182] w-fit absolute top-[75px] right-[50px] shadow-lg animate-bounce-slow max-sm:top-[200px] max-sm:right-[20px]">
          ...
          <div className="p-4 md:p-8 border-t-4 bg-white border-t-[#a6a182] w-fit absolute top-[250px] left-[50px] max-sm:left-[20px] shadow-lg animate-bounce-slow">
