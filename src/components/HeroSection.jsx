...
const HeroSection = () => {
  return (
    <>
      <section
        className={`px-4 sm:px-6 md:px-8 pt-12 md:pt-16 pb-28 max-sm:pb-36`}
      >
        ...
        <div className="relative ">
          ...
          <div className="w-fit p-4 md:p-8 border-t-4 bg-white border-t-[#a6a182] absolute shadow-lg animate-bounce-slow top-[80%] sm:top-[15%] right-[1%] sm:right-[3%]">
          ...
          <div className="w-fit p-4 md:p-8 border-t-4 bg-white border-t-[#a6a182] absolute shadow-lg animate-bounce-slow top-[95%] sm:top-[75%] left-[1%] sm:left-[3%]">
